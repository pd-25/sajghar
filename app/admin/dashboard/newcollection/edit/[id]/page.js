    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (window.$.notify) {
                    window.$.notify({
                        message: 'New Collection updateed successfully!'
                    }, {
                        type: 'success',
                        delay: 2000,
                        z_index: 9999
                ...
                if (window.$.notify) {
                    window.$.notify({
                        message: 'Failed to update New Collection'
                    }, {
                        type: 'danger',
                        delay: 2000,
                        z_index: 9999
        ...
        <div className="container-fluid my-4">
            <div className="card shadow-sm">
                <div className="card-header bg-primary text-white">
                    <h4 className="card-title mb-0">Edit Collection</h4>
                </div>
